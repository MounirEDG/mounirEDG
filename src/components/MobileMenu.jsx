export const MobileMenu = ({menuOpen,setMenuOpen}) => {
    ...
    return (
        <div className={`fixed top-0 left-0 w-full bg-[rgba(10,10,10,0.95)] backdrop-blur-lg z-40 flex flex-col 
        ...
        ${menuOpen ? "h-screen opacity-100 pointer-events-auto" : "h-0 opacity-0 pointer-events-none"} `}>
            ...
            <div className="flex flex-col items-center space-y-6">
                <a href="#home" onClick={()=>setMenuOpen(false)} 
                   className={`text-xl sm:text-2xl font-semibold text-white transform transition-all duration-300 hover:text-blue-400 
